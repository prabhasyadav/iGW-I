...
# 
# The code may also be executed in the book page. You may also run this tool (smartphone optimized) from: [https://keff-app.herokuapp.com/](https://keff-app.herokuapp.com/)
# 
