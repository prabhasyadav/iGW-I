...
# ### Quick self-questioning

# In[8]:


str1 = "Can store and transmit"
str2 = "Can store groundwater but cannot transmit groundwater"
str3 = "Neither store nor transmit groundwater"
str4 = "Can store but only transmit limited groundwater"

nbit.multiple_choice(question="How do you define an aquifer",
                    choices=[str2, str1, str3, str4],
                    answers=1)
...
nbit.multiple_choice(question="Which is NOT an aquifer?",
                    choices=["Unsaturated", "Saturated", "Groundwater table", "Artesian"],
                    answers=2)
